...
/**
 * <p>insureServiceLianGongBao complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="insureServiceLianGongBao">
 *   &lt;complexContent>
...
@XmlType(name = "insureServiceLianGongBao", propOrder = {
    "interfaceNo",
    "datas"
})
public class InsureServiceLianGongBao {
