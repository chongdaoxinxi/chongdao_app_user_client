...
public class AliPayConfig {
    ...
    //回调
    public static final String NOTIFY_URL = "https://47.100.63.167/app_client/api/pay/aliPayCallback";

    public static final String NOTIFY_URL_HT = "https://47.100.63.167/app_client/api/pay/aliPayCallbackHt";
    //保险医疗费用支付宝支付回调
